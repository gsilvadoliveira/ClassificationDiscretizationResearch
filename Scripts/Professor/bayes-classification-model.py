# Bayesian classification model with discrete and continuous attributes,
# considering the example given in the Section 4.2 of the book "Data Mining
# - Practical Machine Learning Tools and Techniques" (Witten et al., 2011)
